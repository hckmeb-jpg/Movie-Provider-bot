...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003022742649').split()] #Channel id for auto indexing ( make sure bot is admin )
...
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1003022742649') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003022742649') # request channel id ( make sure bot is admin )
...
DATABASE_URI = environ.get('DATABASE_URI', "hckmeb")
DATABASE_NAME = environ.get('DATABASE_NAME', "mongodb+srv://hckmeb_db_user:hckmeb@hckmeb.5wovwul.mongodb.net/?retryWrites=true&w=majority&appName=hckmeb")
