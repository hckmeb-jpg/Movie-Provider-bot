...
auth_channel = environ.get('AUTH_CHANNEL', '-100174728951') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID','-100174728951') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-100174728951') # request channel id ( make sure bot is admin )
...
# HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/ROD_MOVIES_FAN') 
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/ROD_MOVIES_FAN') # How to open tutorial link for verification
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ROD_MOVIES_FAN')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+AphCv5Gjm2EwMjVl')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/ROD_MOVIES_FAN') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @abid463')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003027413387')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ROD_MOVIES_FAN') #Support group link ( make sure bot is admin )
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003077279506')).split()]
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003027413387'))
